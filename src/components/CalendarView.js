...
export default function CalendarView({ shifts, config, selectedDate, onDayPress, calculateEarned, onDeleteShift }) {
  ...
  const getMarkedDates = () => {
    ...
    Object.keys(shifts).forEach(date => {
      ...
      else if (dayData.type === 'עבודה' && Number(dayData.totalHours) > Number(config.overtimeStartThreshold || 9)) dotColor = T.orange;
